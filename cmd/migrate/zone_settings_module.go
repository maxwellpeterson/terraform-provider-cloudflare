...
func expandZoneSettingsModules(content string) string {
	...
	for _, match := range matches {
		expanded := expandSingleZoneSettingsModule(match)
		if expanded != "" {
...
func expandSingleZoneSettingsModule(moduleBlock string) string {
